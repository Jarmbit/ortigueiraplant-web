...
if (!function_exists('qode_scripts')) {
    function qode_scripts() {
        ...
        if($qode_options_theme13['enable_google_map'] == "yes") :
        	if(isset($qode_options_theme13['google_maps_api_key']) && $qode_options_theme13['google_maps_api_key'] != '' ){
        	   $google_maps_api_key = $qode_options_theme13['google_maps_api_key'];
